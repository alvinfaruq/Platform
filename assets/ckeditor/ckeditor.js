...
(function () {
				...
				on: function (b, d, h, k, g) {
					...
					if (0 > e.getListenerIndex(d)) {
						...
						for (var t = e.length - 1; 0 <= t; t--)
							if (e[t].priority <= g)
								return e.splice(t + 1, 0, l), { removeListener: v };
						e.unshift(l);
					}
			...
			keystrokeToArray: function (a, b) {
				...
				c &&
					(a[c]
						...
						: (n.push(String.fromCharCode(c)), d.push(String.fromCharCode(c))));
	...
	(function () {
		...
		function d(a, b, c, d, f) {
			...
			if (
				...
				B.type == CKEDITOR.NODE_TEXT &&
				(m.equals(B) ||
					(m.type === CKEDITOR.NODE_ELEMENT && m.getFirst().equals(B)))
			)
				c.append(a.document.createText(B.substring(K, A)));
			else {
				B.type == CKEDITOR.NODE_TEXT
					? l
						? (T = !0)
				...
				for (
					...
					for (
						U != O || (ba.equals(p[U]) && O < q)
							? b && (D = E.append(ba.clone(0, f)))
							: M
							? h(ba, E, !1, C)
							: w && E.append(a.document.createText(ba.substring(K)));
						J;
				...
				for (U = N; U <= q; U++)
					if (((c = p[U]), (J = c.getPrevious()), c.equals(S[U])))
						...
						U != q || (c.equals(S[U]) && q < O)
							? b && (D = E.append(c.clone(0, f)))
							: r
							? h(c, E, !1, F)
							: T && E.append(a.document.createText(c.substring(0, A)));
		...
		CKEDITOR.dom.range.prototype = {
			...
			createBookmark2: (function () {
				function a(b) {
					...
					var f = d;
					n =
						n.type != CKEDITOR.NODE_ELEMENT || 0 === f || f == n.getChildCount()
							? 0
					...
					if (e.type == CKEDITOR.NODE_TEXT) {
						n = e;
						for (f = 0; (n = n.getPrevious()) && n.type == CKEDITOR.NODE_TEXT; )
							f += n
								.getText()
								.replace(
						...
						e.isEmpty()
							? ((f = e.getPrevious(c)),
							  n
									? ((d = n), (e = f ? f.getNext() : e.getParent().getFirst()))
				...
				switch (a) {
					...
					case CKEDITOR.ENLARGE_ELEMENT:
						...
						A.type == CKEDITOR.NODE_TEXT
							? (r &&
									...
									(K = !!A)),
							  A && ((m = A.getPrevious()) || (l = A.getParent())))
						...
						for (l = c(l); l || m; ) {
							if (l && !m) {
								...
								(K && "inline" == l.getComputedStyle("display")) ||
									((K = !1), B ? (k = l) : this.setStartBefore(l));
								m = l.getPrevious();
							}
							for (; m; )
									...
									if (m.type == CKEDITOR.NODE_TEXT)
										...
										if (K && CKEDITOR.dtd.$removeEmpty[m.getName()]) {
											...
											if (d.test(M)) m = null;
												...
												for (
													var r = m.$.getElementsByTagName("*"), C = 0, F;
													(F = r[C++]);

												)
													if (
														!CKEDITOR.dtd.$removeEmpty[F.nodeName.toLowerCase()]
													) {
														m = null;
														break;
													}
						...
						for (; l || m; ) {
							if (l && !m) {
								...
								if (f ? l.isBlockBoundary() : !g.contains(l)) break;
								(K && "inline" == l.getComputedStyle("display")) ||
									((K = !1), B ? (v = l) : l && this.setEndAfter(l));
								m = l.getNext();
							}
							for (; m; ) {
								A = !1;
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						this.setStartAt(
							w,
							!w.is("br") &&
								((!l && this.checkStartOfBlock()) || (l && w.contains(l)))
						...
						this.setEndAt(
							w,
							(!l && this.checkEndOfBlock()) || (l && w.contains(l))
	...
	(function () {
		...
		a.prototype = {
			getNextParagraph: function (a) {
				...
				for (this._.nextNode = null; n; ) {
					...
					if (H) n.type == CKEDITOR.NODE_TEXT && f.test(n.getText()) && (H = 0);
						...
						if (
							...
							n.isBlockBoundary(this.forceBrBreak && !y && { br: 1 })
						) {
							if ("br" == m) H = 1;
							...
							k &&
								(k.setEndAt(n, CKEDITOR.POSITION_BEFORE_START),
				...
				this._.nextNode ||
					(this._.nextNode =
						t || d.equals(u) || !u ? null : this._getNextSourceNode(d, 1, u));
				return d;
			},
	...
	(function () {
		function a(a, b, c, d, e) {
			...
			for (f in b) {
				...
				for (r in T) {
					...
					for (N in g)
						"!" == N.charAt(0) &&
							((N = N.slice(1)), w.push(N), (n[N] = !0), (E = !1));
			...
			if (c && !b) {
				...
				!0 === d
					...
					: (d || (this.customConfig = !1),
					  ...
					  this.allow(
							w[c.enterMode] + " " + w[c.shiftEnterMode],
							"default",
							1
					  ),
		...
		CKEDITOR.filter.prototype = {
			...
			applyTo: function (a, b, c, d) {
				...
				for (; (F = a.pop()); )
					if (((c = F.el), c.parent))
						switch (((g = r[c.parent.name] || r.span), F.check)) {
							case "it":
					...
					for (e = 0; e < a.length; ++e) {
						...
						for (m = 0; m < b.length; ++m)
							(q = b[m]),
								...
								r instanceof CKEDITOR.style && (r = A(r)),
								c.push({
									check: p == f ? null : p,
									left: r,
				...
				if ("string" == typeof a) {
					...
					(f = a.getDefinition()),
						...
						p && !CKEDITOR.tools.isEmpty(p)
							? ((p = C(p)), (d.style = CKEDITOR.tools.writeCssText(p, !0)))
							: (p = {}),
						(f = {
							name: f.element,
							attributes: d,
				...
				0 < r.length
					...
					: ((b = f.attributes["class"]) &&
							(f.attributes["class"] = f.attributes["class"]
								...
								.sort()
								.join(" ")),
					  (c = CKEDITOR.tools.objectCompare(f.attributes, p.attributes, !0)),
				...
				for (var m in b) {
					...
					k &&
						...
						0 <= CKEDITOR.tools.indexOf(k, a.langCode)
							? (B = a.langCode)
							: ((B = a.langCode.replace(/-.*/, "")),
							  (B =
									B != a.langCode && 0 <= CKEDITOR.tools.indexOf(k, B)
										? B
										: 0 <= CKEDITOR.tools.indexOf(k, "en")
										? "en"
										: k[0])),
						h.langEntries && h.langEntries[B]
							? ((a.lang[m] = h.langEntries[B]), (B = null))
							: f.push(CKEDITOR.getUrl(h.path + "lang/" + B + ".js")));
					e.push(B);
					d.push(h);
				}
			...
			for (
				...
				c(l)
					? (f ||
					  ...
					  (h && h.equals(r)) || ((h = r), (g = r.clone()), f.append(g)),
					  g.append(d(l)))
	...
	(function () {
		...
		CKEDITOR.htmlParser.fragment.fromHtml = function (h, k, g) {
			...
			function x(b, c, d) {
				...
				var f = y;
				void 0 === b.previous &&
					(t(c, b) && ((y = c), G.onTagOpen(g, {}), (b.returnPoint = c = y)),
					e(b),
				...
				return function (f) {
					if (f.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
						var q = [],
							...
							F;
						if (p)
							for (r(p, 1) && q.push(p); p; )
								h(p) &&
									(m = c(p)) &&
									r(m) &&
									((F = c(m)) && !h(F)
										? q.push(m)
										: (e(g).insertAfter(m), m.remove())),
									(p = p.previous);
			...
			function r(a, b) {
				...
				return a.type == CKEDITOR.NODE_TEXT &&
					...
					(c.index &&
						...
						(a.value = c[0])),
					(!CKEDITOR.env.needsBrFiller && g && (!b || a.parent.name in w)) ||
		...
		n = (function () {
							  ...
							  T && r in CKEDITOR.dtd.$list
									...
									: ((g = !!k[r]),
									  "br" != r ||
											...
											(C && C != l - 1) ||
											((v =
												(f = C ? h[C - 1].node : w.getItem(C + 1)) &&
												(!a(f) || !f.is("br"))),
											(f = f && a(f) && F.$block[f.getName()])),
									  -1 != n || g || (n = C),
									  g || (A = C),
									  h.push({
											isElement: 1,
			...
			return function (p, w, O, q) {
				...
				if (!q.checkReadOnly()) {
					...
					for (; (G = e(D)) && a(G) && G.isBlockBoundary() && z.contains(G); )
						D.moveToPosition(G, CKEDITOR.POSITION_BEFORE_END);
					r(D, w.blockLimit, z, y);
					u && (D.setEndBefore(u), D.collapse(), u.remove());
					u = D.startPath();
					if ((x = u.contains(f, !1, 1)))
						(V = D.splitElement(x)),
							(w.inlineStylesRoot = x),
							(w.inlineStylesPeak = u.lastElement);
					u = D.createBookmark();
					J && (l(x), l(V));
					...
					D.moveToBookmark(u);
					E.enterMode === CKEDITOR.ENTER_DIV &&
						"" === E.getData(!0) &&
						((E = p.getFirst()) && E.remove(),
					...
					if ((p = O)) {
						...
						if ("text" == w.type && w.inlineStylesRoot) {
							...
							for (V = w.inlineStylesRoot.getParent(); !q.equals(V); )
								(E = E.appendTo(q.clone())), (q = q.getParent());
					...
					if (p) {
						...
						for (h(E, P); V < E.length; V++) {
							...
							if ((J = D.isLineBreak))
								(J = P),
									...
									D.hasBlockSibling
										? (J = 1)
										: (z = J.startContainer.getAscendant(F.$block, 1)) &&
										  z.is({ div: 1, p: 1 })
										? ((y = z.getPosition(x)),
										  ...
										  y == CKEDITOR.POSITION_CONTAINS
												? (J = 0)
												: ((x = J.splitElement(z)),
												  J.moveToPosition(x, CKEDITOR.POSITION_AFTER_START),
												  (J = 1)))
										: (J = 0);
							if (J) O = 0 < V;
							else {
								J = P.startPath();
								!D.isBlock &&
									k(w.editor, J.block, J.blockLimit) &&
									(I = g(w.editor)) &&
									((I = p.createElement(I)),
									I.appendBogus(),
									P.insertNode(I),
									CKEDITOR.env.needsBrFiller &&
										(R = I.getBogus()) &&
										R.remove(),
									P.moveToPosition(I, CKEDITOR.POSITION_BEFORE_END));
								...
								D.lastNotAllowed &&
									V < E.length - 1 &&
									((L = t ? G : L) &&
										P.setEndAt(L, CKEDITOR.POSITION_AFTER_START),
									(u = 0));
								P.collapse();
							}
						}
						...
						R &&
							((O = !0),
							(J = E[0].node),
							P.setStartAt(J, CKEDITOR.POSITION_BEFORE_START),
					...
					for (Z = R.createBookmark(); (Q = w.zombies.pop()); )
						Q.getParent() &&
							((I = R.clone()),
						...
						detectRanges: function (e, f) {
							...
							if (l || p)
								l && p && b(l, p)
									...
									: ((e.tableSurroundingRange = h),
									  h.setEndAt(p, CKEDITOR.POSITION_BEFORE_START),
									  g.setStartAt(p, CKEDITOR.POSITION_AFTER_START)),
	...
	(function () {
		...
		CKEDITOR.on("instanceCreated", function (a) {
			...
			c.on("contentDom", function () {
				...
				if (CKEDITOR.env.ie || CKEDITOR.env.gecko || C)
					n
						? q.attachListener(q, "beforedeactivate", a, null, null, -1)
						: q.attachListener(c, "selectionCheck", a, null, null, -1),
						q.attachListener(
							q,
							...
							if (n) {
								...
								k
									? ((p = b.document.$.body.createTextRange()),
									  ...
									  D.setEndPoint("EndToEnd", p),
									  D.moveEnd("character", -1))
									: ((q = m.getNext(l)),
									  (E = m.hasAscendant("pre")),
									  (q =
											!(q && q.getText && q.getText().match(p)) &&
											(E ||
												!m.hasPrevious() ||
												(m.getPrevious().is && m.getPrevious().is("br")))),
									  (E = b.document.createElement("span")),
									  E.setHtml("\x26#65279;"),
									  E.insertBefore(m),
									  q && b.document.createText("﻿").insertBefore(m));
								b.setStartBefore(m);
								m.remove();
								a
									? (q
									  ...
									  E.remove())
									: (b.setEndBefore(k), k.remove(), D.select());
							} else {
								k = this.getNative();
								if (!k) return;
								...
								for (D = 0; D < a.length; D++) {
									if (
										...
										(E = a[D + 1]),
										(p = q.clone()),
										p.setStart(q.endContainer, q.endOffset),
										p.setEnd(E.startContainer, E.startOffset),
										!p.collapsed &&
											(p.shrink(CKEDITOR.NODE_ELEMENT, !0),
											(b = p.getCommonAncestor()),
											(p = p.getEnclosedNode()),
									...
									b.collapsed &&
										...
										"br" == q.getName()
											? (x(this.root),
											  b.moveToPosition(q, CKEDITOR.POSITION_BEFORE_START))
	...
	(function () {
					...
					if (t.equals(x)) (t = null), (l = !0);
						...
						if (B)
							if (
								...
								(I = k),
								!C ||
									(!(C.getDtd() || CKEDITOR.dtd.span)[H] && !I) ||
						...
						for (
							...
							if (y.getName() == g) {
								for (X in h.attributes)
									!H[X] &&
										(Y = y.getAttribute(W)) &&
										(l.getAttribute(X) == Y ? (B[X] = 1) : (H[X] = 1));
								for (W in h.styles)
									!C[W] &&
										(Y = y.getStyle(W)) &&
										(l.getStyle(W) == Y ? (z[W] = 1) : (C[W] = 1));
							}
							y = y.getParent();
						}
		...
		function G(a) {
			for (
				var b = I(this), c = a.getElementsByTag(this.element), d, e = c.count();
				0 <= --e;
				...
				exec: function (a) {
					for (
						var h =
							...
							p = a.getSelection().getRanges().createIterator(),
							q = function (a) {
								return a.type == CKEDITOR.NODE_ELEMENT;
							},
							n = [],
